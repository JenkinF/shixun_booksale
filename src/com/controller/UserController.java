...
public class UserController extends BaseController {
	...
	public String selectAll(HttpServletRequest request) {
		...
		Page<Object> page = PageHelper.startPage(pageindex, 6); //使用pageHelper实现分页
	...
	public String usernameCheck(String username, HttpServletRequest request,
	...
	public String userDelAll(HttpServletRequest request,
			HttpServletResponse response) {
